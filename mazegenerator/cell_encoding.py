...
def get_cell_type(cell: MazeCell) -> str | None:
    """
        Decode the type of a cell from bits 4-7 of cell.value.
        Returns:
            A single character matching the encoded type:
            'n' normal, 's' start, 'e' end, 'r' road,
            'o' origin, 'v' visited, 'l' locked.
            None if the bit pattern is unrecognised.
    """
    # binary of locked 1111 ****
